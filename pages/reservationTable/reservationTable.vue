<template>
	<view>
		<view class="container">
			...
			<view class="time">
				<view v-for="(timeItem,timeIndex) in timeArr" :key="timeIndex" @click="selectTime(timeIndex)"
					class="listItem" :class='[currentTime===timeIndex? "current":""]'>
					<view class="text">{{ timeItem.time }}</view>
					<view class="text">{{ timeItem.status }}</view>
				</view>
			</view>
			<view class="button">
